...
<head>
	...
	<title>Olhos Desafiantes - Home</title>
...
<div id="Corpo">
	...
	<div id="conteudo">
		<h2 class="titulo-pagina">Jogue Olhos Desafiantes!!!</h2>
		<div class="home">
			<a class='irdownload' href='download.php'>Fazer Download</a>
			<h3 class="home-texto">Jogue Olhos Desafiantes e ajude o Zoio a subir o castelo do Alek para fazer “O desafio impossível”, que ele recebeu após uma mensagem anônima que ele leu em seu inbox do youtube. Feito na engine GODOT, é uma releitura do jogo Crash Bandicoot: The Wrath of Cortex junto com Super Mario World e Metal Slug X. </h3>
			<div class="home-imgs">
				<div id="img1">
				</div>
				<div id="img2">
